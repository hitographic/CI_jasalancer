...
class Kelola_user2 extends CI_Controller
{
    ...
    public function json()
    {
        ...
        echo $this->Kelola_user_model->json();
    }

    public function read($id)
    {
        $row = $this->Kelola_user_model->get_by_id($id);
        if ($row) {
            $data = array(
        'id' => $row->id,
        'name' => $row->name,
    ...
    public function create()
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('kelola_user/create_action'),
        'id' => set_value('id'),
        'name' => set_value('name'),
        ...
        $this->load->view('kelola_user/user_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        'date_created' => $this->input->post('date_created', true),
            ...
            $this->Kelola_user_model->insert($data);
    ...
    public function update($id)
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('kelola_user/update_action'),
    ...
    public function update_action()
    {
        ...
        'date_created' => $this->input->post('date_created', true),
            ...
            $this->Kelola_user_model->update($this->input->post('id', true), $data);
    ...
    public function delete($id)
    {
        ...
        if ($row) {
            $this->Kelola_user_model->delete($id);
    ...
    public function excel()
    {
        ...
        foreach ($this->Kelola_user_model->get_all() as $data) {
            $kolombody = 0;
    ...
    public function word()
    {
        ...
        $data = array(
            'user_data' => $this->Kelola_user_model->get_all(),
            'start' => 0
        );
        
        $this->load->view('kelola_user/user_doc', $data);
    }
}

/* End of file Kelola_user.php */
/* Location: ./application/controllers/Kelola_user.php */
