    ...
    <div class="row mt-3">
        <div class="col-md-6">
            ...
            <div class="card">
                ...
                <?= form_open_multipart('pekerjaan/ubah'); ?>
                        <div class="form-group">
                            <input type="hidden" class="form-control" id="id" name="id" value="<?= $peoples['id']; ?>"
                                readonly>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi"
                                rows="5"><?= $peoples['deskripsi']; ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <?php foreach ($kategori as $m): ?>
                                <?php if ($m['id'] == $peoples['id_kategori']) :?>
                                <option value="<?= $m['id']; ?>" selected><?= $m['kategori']; ?></option>
                                <?php else : ?>
