    ...
    <div style="padding:1% 3% 1% 3%;">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <!--awal profil-->
                <div class="card">
                    <img src="<?= base_url(); ?>assets/img/img1.png" class="card-img-top justify-content-center utama"
                        alt="...">
                    <div class="card-body">
                    <h2 class="card-title">Marina UV white</h2>    
                ...
                <div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <h4>SEO expert dan Web programmer</h4>
                        </div>
                    </div>
                    <div class="panel panel-primary">
