<div class="jumbotron halaman2">
    <h1 class="display-4">Freelancer :<br><span style="color:#ffc857;"> <?= $profil['name']; ?> </span></h1>
</div>
<!--main body-->
<div class="container">
    <div style="padding:1% 3% 1% 3%;">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <!--awal profil-->
                <div class="card">
                    <img src="<?= base_url('assets/img/profile/').$profil['image']; ?>"
                        class="card-img-top justify-content-center utama" alt="...">
                    <div class="card-body">
                        <h5 class="card-title text-center font-weight-bold text-capitalize"><?= $profil['name']; ?></h5>
                        ...
                        <p class="card-text text-center"><small class="text-muted">Member Sejak
                                <span
                                    class="font-weight-bold"><?= date('d F Y', $profil['date_created']); ?></span></small>
                        </p>
                        <!-- <ul class="list-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="container">
                                    <p class="card-text font-weight-bold">Nama</p>
                                        ...
                                        <div class="shadow-sm p-3 mb-3 bg-white rounded"><?= $profil['name']; ?></div>
                            ...
                            <div class="col-lg-6">
                                <div class="container">
                                    ...
                                    <div class="shadow-sm p-3 mb-3 bg-white rounded"><?= $profil['email']; ?></div>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="container">
                                    ...
                                    <div class="text-capitalize shadow-sm p-3 mb-3 bg-white rounded "><?= $profil['nama_kota']; ?></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="container">
