...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?= form_open_multipart('client/edit'); ?>
            ...
            <div class="form-group row">
                <label for="prof_sum" class="col-sm-2 col-form-label">Bio</label>
                <div class="col-sm-10">
                    <textarea class="form-control" id="prof_sum" name="prof_sum"
                        rows="5"><?= $profil['prof_sum']; ?></textarea>
                </div>
            </div>
